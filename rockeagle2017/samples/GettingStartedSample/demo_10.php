...
$apiRequest = '/d2l/api/lp/1.0/enrollments/';
$apiMethod = 'POST';
$data = '{"OrgUnitId": "801018","UserId": "813214","RoleId": "157"}';
...
<head>
    <title>Rock Eagle 2017 Demo 10</title>
    <style type = "text/css">
        table.plain
        {
...
$userId     =   '';
$userKey    =   '*********************';
<font color='red'>$apiRequest =   '/d2l/api/lp/1.0/enrollments/';
$apiMethod  =   'POST';
$data       =   '{
                    "OrgUnitId": "(Course Offering OrgUnitID)",
                    "UserId": "(User D2LID)",
                    "RoleId": "157"
                }';</font>
