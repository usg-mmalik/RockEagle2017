...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <input name="appIDField" type="password" style="width:20em" value="<?php echo $appId; ?>" id="appIDField" />
            </td>
            <td>
                <b>App Key:</b>
            </td>
            <td>
                <input name="appKeyField" type="password" style="width:20em" value="<?php echo $appKey; ?>" id="appKeyField" />
            </td>
        </tr>
    </table>
    <div id="userDiv">
