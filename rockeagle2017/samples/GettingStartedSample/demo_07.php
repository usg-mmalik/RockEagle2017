...
$apiRequest = '/d2l/api/lp/1.0/users/813214';
$apiMethod = 'PUT';
$data = '{"OrgDefinedId": "rockeagle","FirstName": "Rock","MiddleName": "","LastName": "Eagle","ExternalEmail": "rock.eagle@usg.edu","UserName": "rockeagle",  "Activation": {"IsActive": true}}';
...
<head>
    <title>Rock Eagle 2017 Demo 07</title>
    <style type = "text/css">
        table.plain
        {
...
$userId     =   '';
$userKey    =   '*********************';
<font color='red'>$apiRequest =   '/d2l/api/lp/1.0/users/(User OrgUnitID)';
$apiMethod  =   'PUT';
$data       =   '{
                  ...
                  "MiddleName": "",
                  "LastName": "Eagle",
                  "ExternalEmail": "rock.eagle@usg.edu",
                  "UserName": "rockeagle",
                    "Activation": {
                        "IsActive": true
                    }
