...
$apiRequest = '/d2l/api/lp/1.0/coursetemplates/';
$apiMethod = 'POST';
$data = '{"Name": "Rock Eagle Template","Code": "template.rockeagle","Path": "","ParentOrgUnitIds": ["6986"]}';
...
<head>
    <title>Rock Eagle 2017 Demo 08</title>
    <style type = "text/css">
        table.plain
        {
...
$userId     =   '';
$userKey    =   '*********************';
<font color='red'>$apiRequest =   '/d2l/api/lp/1.0/coursetemplates/';
$apiMethod  =   'POST';
$data       =   '{
                    "Name": "Rock Eagle Template",
                    "Code": "template.rockeagle",
                    "Path": "",
                    "ParentOrgUnitIds": ["(Dept OrgUnitID)"]
                }';</font>
